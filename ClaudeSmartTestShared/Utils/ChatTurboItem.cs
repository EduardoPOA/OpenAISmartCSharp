...
namespace Eduardo.OpenAISmartTest.Utils
{
    ...
    public class ChatTurboItem
    {
        ...
        public ChatTurboItem(AuthorEnum author, string message, bool firstSegment, int index)
        {
            ...
            {
                ImageSource = "pack://application:,,,/OpenAISmartTest;component/Resources/vs.png";
            ...
            {
                ImageSource = firstSegment ? "pack://application:,,,/OpenAISmartTest;component/Resources/chatGPT.png" : string.Empty;
